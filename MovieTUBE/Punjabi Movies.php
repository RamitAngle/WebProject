        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Punjabi</h1>
                    <!-- <p class="lead fw-normal text-white-50 mb-0">With this shop hompeage template</p> -->
                </div>
            </div>
        </header>
        <!-- Movir Grid View Section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php $res=mysqli_query($db,"SELECT* from movie where catagory = 'Punjabi Movies'");
				...
				echo '
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Sale badge-->
                            <div class="badge bg-dark text-white position-absolute" style="top: 0.5rem; right: 0.5rem">Movies</div>
                            <!-- Product image-->
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <br>
                                    <h7 class="fw-bolder">Catagory: </h7>
                                    <span class="text-decoration">'.$row['catagory'].'</span>
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="movie detailspage.php?id='.$row['id'].'">Know More</a></div>
                            </div>
                        </div>
                    </div> ';
                } ?>
