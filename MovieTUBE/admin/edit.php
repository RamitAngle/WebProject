...
$result=mysqli_query($db,"UPDATE movie SET image='$image_file',title='$title',sd='$sd',ld='$ld',launguage='$launguage', CDFC='$CDFC' , catagory='$catagory', song_link='$song_link', movie_link='$movie_link'  WHERE id=$id"); 
	}
	else 
	{
	$result=mysqli_query($db,"UPDATE movie SET title='$title',sd='$sd',ld='$ld',launguage='$launguage' ,CDFC='$CDFC' ,catagory='$catagory' , song_link='$song_link', movie_link='$movie_link' WHERE id=$id"); 	
	} 
if($result)
{
 header("location:movie.php?action=saved");
}
else 
{
...
<form action="" method="POST" enctype="multipart/form-data">
	...
	<img src="uploads98/<?php echo $image;?>" height="100"><br>
