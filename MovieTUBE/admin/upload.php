...
$result=mysqli_query($db,"INSERT INTO movie (image,title,sd,ld,launguage,CDFC,catagory,song_link,movie_link) VALUES('$image_file','$title','$sd','$ld','$launguage','$CDFC','$catagory','$song_link','$movie_link')"); 
if($result)
{
	header("location:movie.php?image_success=1");
}
else 
{
...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <option value="Hindi Dubbed Movies">Hindi Dubbed Movies</option>
